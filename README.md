...
<image src="/Images/Tiny doctors examining gut flora flat vector illustration.jpg" alt= "Imagen creada por pch.vector en Freepik." width="250"> <image src="/Images/mujeres_entrenando.jpg" alt= "Imagen creada por pch.vector en Freepik." width="250"> <image src="/Images/coleccion_bacterias.jpg" alt= "Imagen creada por Freepik." width="250">
